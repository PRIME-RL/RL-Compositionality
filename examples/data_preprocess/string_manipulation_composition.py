...
if __name__ == "__main__":
    ...
    parser.add_argument('--local_dir', default="data/synthetic_data/synthetic_string_manipulation_composition_8level_complete_train")
    ...
    for depth in depths:
        for i, data in enumerate([forward_data]):
            ...
            while count < total_samples_per_depth:
                ...
                if i == 0:
                    sample = {
                        "data_source": f"codeio-forward-complete-depth{depth}",
                        "prompt": [{
                            "role": "user",
                    ...
                    sample = {
                        "data_source": f"codeio-backward-complete-depth{depth}",
                        "prompt": [{
                            "role": "user",
