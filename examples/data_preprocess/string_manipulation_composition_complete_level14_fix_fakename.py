...
if __name__ == "__main__":
    ...
    parser.add_argument('--local_dir', default="data/synthetic_data/synthetic_string_manipulation_composition_1234level_complete_train_fix_fakename")
    ...
    for set_idx, custom_functions in enumerate([all_set]):
        forward_data = []
        backward_data = []
