...
def random_expr(depth=1):
    ...
    # Uniformly select one operation from the master list.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--local_dir', default="data/synthetic_data/synthetic_string_manipulation_single")
    args = parser.parse_args()

    depths = [1]
    total_samples_per_depth = 100000
    forward_data = []
    backward_data = []
